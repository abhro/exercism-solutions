...
public class NaturalNumberTest {
     ...
     * (https://en.wikipedia.org/wiki/Divisor#Further_notions_and_facts), and
     * the additive identity is 0, so the aliquot sum of 1 should be 0. Hence
     * 1 should be classified as deficient.
     */
