...
class GrepTest < Minitest::Test
  def setup
    IO.write 'iliad.txt', <<~END_OF_ILIAD
    ...
    IO.write 'midsummer-night.txt', <<~END_OF_MIDSUMMER_NIGHT
    ...
    END_OF_MIDSUMMER_NIGHT

    IO.write 'paradise-lost.txt', <<~END_OF_PARADISE_LOST
  ...
  def test_one_file_one_match_no_flags
    ...
    assert_equal expected, Grep.grep('Agamemnon', [], ['iliad.txt'])
  end
  ...
  def test_one_file_several_matches_no_flags
    ...
    assert_equal expected, Grep.grep(pattern, [], files)
  end
  ...
  def test_one_file_several_matches_inverted_flag
    ...
    assert_equal expected, Grep.grep(pattern, ['-v'], files)
  end
  ...
  def test_one_file_several_matches_inverted_and_match_entire_lines_flags
    ...
    assert_equal expected, Grep.grep(pattern, ['-x', '-v'], ['iliad.txt'])
  end
  ...
  def test_multiple_files_several_matches_case_insensitive_flag
    ...
    assert_equal expected, Grep.grep('TO', ['-i'], files)
  end
