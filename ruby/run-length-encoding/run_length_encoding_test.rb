...
class RunLengthEncodingTest < Minitest::Test
  def test_encode_empty_string
    assert_equal '', RunLengthEncoding.encode('')
  end

  def test_encode_single_characters_only_are_encoded_without_count
    assert_equal 'XYZ', RunLengthEncoding.encode('XYZ')
  end
  ...
  def test_decode_empty_string
    assert_equal '', RunLengthEncoding.decode('')
  end

  def test_decode_single_characters_only
    assert_equal 'XYZ', RunLengthEncoding.decode('XYZ')
  end
